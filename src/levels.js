...
export const TILE_ROPE = 4;
export const TILE_FALSE_BRICK = 5;
export const TILE_EXIT_LADDER = 6;
export const TILE_GOLD = 7;
export const TILE_GUARD = 8;
export const TILE_PLAYER = 9;
